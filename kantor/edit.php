...
$db = new database();
$id_kantor = $_GET['id'];
if(! is_null($id_kantor))
{
	$data_kantor = $db->get_by_id($id_kantor);
}
else
{
...
<html lang="en">
  <head>
    ...
    <title>Office Edit | forSAS</title>
...
<br>
    <div class="card">
        ...
        <div class="card-body">
        <form method="post" action="proses_kantor.php?action=update">
        <input type="hidden" name="id_kantor" value="<?php echo $data_kantor['id']; ?>"/>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nama Kantor</label>
                <input type="text" name="nama_kantor" value="<?php echo $data_kantor['nama_kantor']; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Alamat</label>
                <input type="text" name="alamat" value="<?php echo $data_kantor['alamat']; ?>"  class="form-control" id="exampleInputPassword1">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">No. Telp</label>
                <input type="text" name="no_telp"value="<?php echo $data_kantor['no_telp']; ?>" class="form-control" id="exampleInputPassword1">
            </div>
