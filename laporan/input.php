...
<div class="card ">
    ...
    <!-- Nama kantor -->
        ...
        <div class="form-group">
         ...
         <div>
            <div class="form-group">
              ...
              <input type="text" name="waktu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
            </div>
          </div>
      ...
      <label for="mesin_tempel" style="font-weight:bold">Pompa</label> <br>
        <div class="form-check form-check-inline">
          <label for="mesin_tempel">                   
            <input type="radio" name="pompa" value="Standby" required>Standby
            <br>
            <input type="radio" name="pompa" value="Unavailable"  >Unavailable
          </label>
        </div>    
      </div>  
      </div>
      ...
      <div class="col">
        <div class="form-group">
            <label for="exampleInputPassword1" style="font-weight:bold">Kapasitas (lt.)</label>
      ...
      <label for="mesin_tempel" style="font-weight:bold">Genset (PLN)</label> <br>
        ...
        <div class="form-group">
      <label for="mesin_tempel" style="font-weight:bold">Genset (Pompa)</label> <br>
        <div class="form-check form-check-inline">
          <label for="mesin_tempel">                   
            <input type="radio" name="genset_pompa" value="Standby" required>Standby
            <input type="radio" name="genset_pompa" value="Unavailable"  >Unavailable
          </label>
        </div>    
      </div>  
        </div>
        ...
        <div class="form-group">
            <label for="exampleInputPassword1"style="font-weight:bold">Pelapor</label>
            <input type="text" class="form-control" name="pelapor" id="exampleInputPassword1" value="<?php echo $_SESSION['nama']; ?>" required>
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1"style="font-weight:bold">Kondisi</label>
