...
<?php
    ...
    <br><br><br>
    <h5>Laporan</h5>
    <h5><?php echo $result['id_laporan']; ?></h5>
    ...
    <tbody>
        <tr>
      <td><?php echo $result['nama_kantor']; ?></td>
      ...
      <td><?php echo $result['bbm']; ?></td>
      <td><?php echo $result['kapasitas']; ?></td>
      <td><?php echo $result['catudaya']; ?></td>
      <td><?php echo $result['cuaca']; ?></td>
      <td><?php echo $result['suhu_central']; ?></td>
      <td><?php echo $result['suhu_trans']; ?></td>
      <td><?php echo $result['suhu_rect']; ?></td>
