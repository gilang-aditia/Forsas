...
class database{
	...
	function tambah_data($nama_kantor,$alamat,$no_telp)
	{
		mysqli_query($this->koneksi,"insert into kantor values ('','$nama_kantor','$alamat','$no_telp')");
	}
	...
	function update_data($nama_kantor,$alamat,$no_telp,$id_kantor)
	{
		$query = mysqli_query($this->koneksi,"update kantor set nama_kantor='$nama_kantor',alamat='$alamat',no_telp='$no_telp' where id='$id_kantor'");
	}
